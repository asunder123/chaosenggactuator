...
module.export = function ChaosMonkey(app,config){
 this.app = app;
 this.config = config;
 return new ChaosMonkey('actuator','');
};
//const chaos = new ChaosMonkey('actuator','');
//chaos.start();
//module.exports = require('./chaos-control/chaos-control');
//var config = require('config');
var app = express();
//new ChaosMonkey(app, require('config') ).start();
...
/*const recorder = new BatchRecorder({
  logger: new HttpLogger({
    ...
    jsonEncoder: JSON_V1, // JSON encoder to use. Optional (defaults to JSON_V1)
